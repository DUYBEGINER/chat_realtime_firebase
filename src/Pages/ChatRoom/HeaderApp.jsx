...
function HeaderApp(props) {
  ...
  // Kiểm tra xem selectedRoom có phải là object rỗng không (hoặc null/undefined)
  const isRoomLoaded = selectedRoom && Object.keys(selectedRoom).length > 0;
  ...
  return (
    <div className="bg-white dark:bg-bgdark flex  border border-gray-300 dark:border-gray-500 px-4 py-4">
      ...
      <div className="w-full flex text-left items-center justify-between ms-4">
        ...
        : <Skeleton.Input active paragraph={{ rows: 2 }} />}
      </div>
    </div>
  );
}
